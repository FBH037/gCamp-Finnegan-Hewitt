class FaqController < ApplicationController
  def index
    ...
    @faq = Faq.new
    @faq.question = ["What is gCamp?",
                     "How do I join gCamp?",
                     "When will gCamp be finished?"]

    @faq.answer = ["gCamp is an awesome tool that is going to change your life.  gCamp is your one stop shop to organize all your tasks.  You'll also be able to track comments that you and others make.  gCamp may eventually replace all need for paper and pens in the entire world.  Well, maybe not, but it's going to be pretty cool.",
    ...
    @faq.slug = ["what_is_gcamp",
                 "how_do_i_join_gcamp",
                 "when_will_gcamp_be_finished"]
  end
end
